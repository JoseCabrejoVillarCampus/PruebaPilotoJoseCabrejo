...
class position extends connect
{
    ...
    private $queryUpdate = 'UPDATE position SET id = :identificacion, name_position = :posicion, arl = :_arl  WHERE id = :identificacion';
    private $queryDelete = 'DELETE FROM position WHERE id = :identificacion';
    private $message;
    use getInstance;
